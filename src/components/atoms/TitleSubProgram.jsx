...
function TitleSubProgram({ school, backgroundColour, imgRight, imgLeft }) {
  ...
  return (
    <>
      ...
      <h1 data-aos="fade-up" data-aos-duration="1000" className={`text-xl md:text-4xl xl:text-5xl ${backgroundColour} font-semibold flex text-center justify-center xl:w-[901px] mx-auto pb-12`}>PROGRAM UNGGULAN {school}</h1>
    </>
  )
}
